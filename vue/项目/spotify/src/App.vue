      ...
      <button @click="openMenu = !openMenu" :class="openMenu ? 'bg-[#282828]' : 'bg-black'"
        ...
        <div class="flex items-center">
          <img class="rounded-full" width="27"
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTyxxpCN65Q2e0Mhz9_V_N9JtzSYpNmkc5OeQ&s">
          <div class="text-white text-[14px] ml-1.5 font-semibold">Alo</div>
